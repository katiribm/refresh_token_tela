...
if __name__ == "__main__":
    ...
    url = "https://tributos.betha.cloud/tributos/v1/api/cadastros/referentes/economicos"
    #url = "https://tributos.betha.cloud/tributos/v1/api/cadastros/enderecos/logradouros"
    #url = "https://tributos.betha.cloud/tributos/v1/api/cadastros/enderecos/bairros"
